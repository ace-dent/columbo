...
flowchart TD
    ...
    R1 -- "No" --> DEFAULTEND["Retain complete Default result"]
    RESTORE --> DEFAULTEND
...
flowchart TD
    ...
    R1 -- "Yes" --> RESTORE["🟢 Restore certified matches under unchanged trees"]
    R1 -- "No" --> PICKMAX["Select byte/meaningful-bit winner<br/>or relaxed raw source"]
    RESTORE --> PICKMAX
```
