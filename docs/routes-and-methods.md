...
flowchart TD
    ...
    POLICY -- "Complete" --> CFLOOR["🟡 Mandatory ordinary comparison floor<br/>optional R6–R8 within remaining Max allowance"]
...
flowchart TD
    ...
    R8 -- "No" --> PICKMAX["Select byte/meaningful-bit winner<br/>or relaxed raw source"]
    ROTATE --> PICKMAX
```
...
with R6–R8 before continuing its historical Max seed. These optional
