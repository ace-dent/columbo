...
flowchart TD
    ...
    POLICY -- "Complete" --> CFLOOR["🟡 Mandatory ordinary comparison floor<br/>optional R6/R7 within remaining Max allowance"]
...
flowchart TD
    ...
    R7 -- "No" --> PICKMAX["Select byte/meaningful-bit winner<br/>or relaxed raw source"]
    CLTREE --> PICKMAX
```
...
with R6 and R7 before continuing its historical Max seed. These optional
...
and R7 after R5 while G0 remains open.
