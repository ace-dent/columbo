...
| Data trees | DeflOpt, Defluff, deft4j, and Columbo builders; source-tree reuse; equal-frequency assignments; swaps; two pseudo-frequency methods; pair/quad Kraft moves; paired pricing | A concrete absent near-optimal tree shape |
...
| [ECT](https://github.com/fhanau/Efficient-Compression-Tool) | Modified zlib/Zopfli recompression | Comparison encoder only |
...
- 437 Rust tests, formatting, and warning-free Clippy passed on Apple Silicon;
- `x86_64-pc-windows-gnu` compile check passed;
- GZIP, PNG, zlib, and ZIP outputs were byte-identical to the exact pre-change
  executable; and
- GZIP/ZIP integrity checks and PNG/zlib Columbo reparsing passed.
